  ...
  const handleFileChange = (e) => {
    ...
    if (selectedFile) {
      ...
      if (!validExtensions.includes(fileExtension)) {
        setMessage(
          "Por favor, selecione um arquivo válido (.xlsx, .xls ou .csv)"
        );
    ...
    <div className="import-excel-container">
      ...
      <div className="template-section">
        <button
          ...
          aria-label="Baixar template CSV para importação"
          title="Baixar arquivo modelo CSV"
        >
          📥 Baixar Template CSV
        </button>
      </div>
        ...
        <button
          ...
          aria-label={
            loading
              ...
              : "Importar arquivo Excel selecionado"
          }
          title={loading ? "Importando..." : "Clique para importar"}
        >
