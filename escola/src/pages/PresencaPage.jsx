...
const PresencaPage = () => {
  ...
  useEffect(() => {
    // Simula a busca de dados da turma
    const foundTurma = turmasData.find((t) => t.id.toString() === turmaId);
    if (foundTurma) {
      setTurma(foundTurma);
      // Inicializa o estado de presença com todos "presente" por padrão
      const initialAttendance = foundTurma.alunos.reduce((acc, aluno) => {
        acc[aluno] = "presente";
        return acc;
      }, {});
